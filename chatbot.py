...
# Funções auxiliares (classify_user_intent, generate_dynamic_query, process_question_with_insights)
# Mantidas iguais ao seu código original, sem alterações aqui por brevidade
...
def main():
    ...
    # Interface inicial mínima
    if not st.session_state.data_loaded:
        st.info("Carregando dados da base... Isso pode levar alguns segundos na primeira interação.")
    
    # Criar a cadeia de execução padrão
    ...
    with st.sidebar:
        ...
        # ... (outras sugestões mantidas iguais)
